    ...
    <div>
      <section>
        <div className="relative shadow-lg">
          <div
            className="absolute w-full h-full opacity-20 filter blur-sm contrast-100  bg-black hover:opacity-40 transition ease-in-out duration-150">
          </div>
          <img className="max-h-96 w-full object-cover" src="{{asset('assets/images/cover-rpg.jpg')}}"
            alt="Imagem de jogadores de RPG"/>
          <h1
            className="absolute cursor-default pointer-events-none left-0 right-0 bottom-3 text-center text-xl text-gray-100 font-bold mb-2 sm:text-5xl">
            Taverna de Mordor</h1>
        </div>
      </section>
      <div>
              ...
              <div className="w-2/3 h-auto relative flex flex-grow top-0 bottom-0 bg-cover bg-tabuleiro-rpg">
                ...
                <div className="w-100 justify-center mx-auto z-30 my-auto p-3 sm:p-10">
                  <span className="px-3 text-lg sm:text-2xl z-30 text-center text-white">
                    <strong className="z-30">A Regra de Ouro do RPG:</strong> "Para o Bem e Para o Mal... Diversão até o final!"
                  </span>
                </div>
              </div>
              <div className="w-2/3 ml-6 sm:ml-12 flex flex-col py-32 pr-5 sm:pr-0">
                <br/>
                <strong className="text-xl sm:text-3xl text-gray-800">
                ...
                <p className="text-lg font-sans">
                  O Site da taverna de mordor surgiu com o objetivo de unir jogar com
                  organizar os jogos, gerenciar mesas e participar de eventos
                </p>
                <br/>
                <br/>
                <strong className="text-xl sm:text-3xl text-gray-800">
                  <i className="far fa-flag text-2xl mr-3"></i>
                  Qual a nossa meta?
                </strong>
                <br/>
                <br/>
                <p className="text-lg font-sans">
                  Dar total autonomia para o mestre gerenciar sua mesa e para os admistradores
                  terem uma visão geral sobr/e os jogadores quanto os mestres e as mesas
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto mt-5 sm:mt-8">
            ...
            <div className="hidden grid-flow-col grid-rows-2 grid-cols-3 gap-5 sm:grid">
              <div className="bg-vampire-the-mascarade bg-center rounded-md overflow-hidden">
                <a href="https://www.worldofdarkness.com/vampire-the-masquerade">
