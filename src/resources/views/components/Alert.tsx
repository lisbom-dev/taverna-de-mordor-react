  ...
  return (
    <div>
      <div className="animate-slide-from-right">
        <div
          className="bg-blue-600 shadow-lg mx-auto w-full max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3"
          id="static-example"
          role="alert"
          aria-live="assertive"
          aria-atomic="true"
        ...
        >
          <div className="bg-blue-600 flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-blue-500 rounded-t-lg">
            ...
            <div className="flex items-center">
              <p className="text-white opacity-90 text-xs">agora</p>
              <button
                type="button"
                className="btn-close btn-close-white box-content w-4 h-4 ml-2 text-white border-none rounded-none opacity-50 pr-3 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-white hover:opacity-75 hover:no-underline"
          ...
          <div className="p-3 bg-blue-600 rounded-b-lg break-words text-white"></div>
        </div>
        <div
          className="bg-yellow-500 shadow-lg mx-auto w-full max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3"
          id="static-example"
          role="alert"
          aria-live="assertive"
          aria-atomic="true"
        ...
        >
          ...
          <div className="p-3 bg-yellow-500 rounded-b-lg break-words text-white"></div>
        </div>
        <div
        ...
        >
          ...
          <div className="p-3 bg-red-600 rounded-b-lg break-words text-white"></div>
        </div>
        <div
