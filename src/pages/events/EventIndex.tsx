  ...
  <Main>
    <div className="container mx-auto mt-10 rounded-lg px-2 py-10 md:px-6 shadow-2xl w-full ">
      <div className="md:mx-24 lg:flex">
        <div className="flex m-5 items-center">
          ...
          <p className="flex italic bg-gray-100 p-5 h-auto px-5 rounded-lg shadow-md w-1/3 md:w-2/3" />
          <br />
        </div>
        <div className=" flex m-5">
          <div className=" flex items-center">
            <i className="fas fa-dice text-lg mr-2" />
          ...
          <p className="flex bg-gray-100 p-5 md:px-14 items-center rounded-lg shadow-md w-1/3  md:w-2/3 h-auto" />
          <br />
        </div>
        <div className=" flex m-5 items-center">
          <div className=" flex">
          ...
          <p className="flex h-auto bg-gray-100 p-5 px-5 rounded-lg shadow-md w-1/3 md:w-2/3" />
          <br />
        </div>
      </div>
      <div className="md:flex m-5 mb-10">
        <div className="flex md:mx-24 w-full">
          ...
          <div className="w-full">
            ...
            <p className="md:flex bg-gray-100 p-5 w-full  rounded-lg shadow-md lg:w-full" />
            <br />
          </div>
        </div>
      </div>
    ...
    <div className="border bg-white  container mx-auto rounded-lg px-2 py-1 my-3 mt-7 md:mb-16 md:py-10 shadow-2xl">
      <div className="flex m-5 space-x-3">
        <i className="text-2xl fas fa-dice " />
